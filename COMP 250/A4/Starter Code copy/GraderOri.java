...
//                long durationFast = TimeUnit.NANOSECONDS.toMicros(endTime-startTime);
                ...
                switch(i) {
                    case 10: diff = 100000;
                        break;
                    case 100: diff = 250000;
                        break;
                    case 1000: diff = 5000000;
                        break;
                    case 10000: diff = 50000000;
                        break;
                    case 100000: diff = 2147000000;
                        break;
                }

                if ((durationSlow-durationFast) >= diff) {
            ...
            write(gradeString(tooSlow ? 0 : maxScore, maxScore, comment));
        }
        catch (Exception e) {
            comment = comment + "Exception Found: " + e.toString() + "\n";
            e.printStackTrace();
